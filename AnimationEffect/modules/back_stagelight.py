...
def back_stagelight_effect (cap, frame, back_cap, back_frame, out, in_video, i) :
   
    eff_path = './Effects/back/stagelight.mp4'
    ...
    while(cap.isOpened()):
        ...
        # Give Opacity
        frame = cv2.addWeighted(back_frame,0.1+0.002*(i-start),frame,0.9-0.002*(i-start),0)
